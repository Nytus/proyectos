...
public class Tienda extends Menu {
	...
	public void ofrecerProducto(Enemigo enemigo1,Ataque_ene tipoAtaque, Ataque_j1 dañoj1 ,Heals curacion, Armas arma1, Armas arma2, Armas arma3, Jugador jugador1, Overworld menu) {
			...
			if (numero == 1) {
				...
				System.out.println("¿Te refieres al mounstruo verdad?");
				System.out.println("Si, es un dolor de cabeza tenerlo cerca");
				System.out.println("Llego hace unos dias y no se ha ido");
				System.out.println("El otro dia con su cola dio vuelta mi basurero");
				System.out.println("Lo peor de todo es que ni siquiera se disculpo ");
				System.out.println("Creo que se esconde en la iglesia ");
				System.out.println("Lo se por que trate de vengarme lanzandole papas");
				System.out.println("Si.... no funciono ... pero puedes intentarlo tu");
				System.out.println("Si necesitas algo puedes venir a verme aqui");
				System.out.println("Oh si tambien lo olvidaba , ese mounstruo se robo la billetera de mi vecino");
				System.out.println("Mi vecino es un idiota toma el dinero que encuentres y traemelo para que te venda cosas");
			}
			else if(numero ==2 ) {
				if(jugador1.dinero >= 10) {
